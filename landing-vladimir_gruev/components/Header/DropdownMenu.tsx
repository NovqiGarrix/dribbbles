...
const DropdownMenu: FunctionComponent<IFeaturesMenu> = (props) => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="z-50 origin-top-right top-3 absolute right-3 mt-2 w-60 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none">
